public class Station 
{
    ...
    public void connectTo(String stationToConnectTo, int travelTime)    //Adds a conection to a station's list of connections
    {
    ...
    public int canIGetTo(String stationToGoTo)                          //Checks if a station is connected to this station and returns the time it would take to do so, returns 0 if the station cannot be reached, maybe change to -1 or something clearer in future
    {
