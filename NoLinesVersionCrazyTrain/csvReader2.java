...
public class csvReader2 extends csvReader                                                                                                //Class to read the first csv type used with 3 values max per line
{
    ...
    {                   
        super(fileName);                                                                                    // Reads the csv file into the array for use later in the data reader
    }
    ...
    public lineOfText2[] readCSVData2()                               //Reads the csv file's data from the linesOfText array into an array of linesOfText, which is then returned for use in the parent class
    {
